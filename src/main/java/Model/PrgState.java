...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIFileTable file, MyIHeap heap,  IStmt prg, MyISem sem, MyILock lock) {
        exeStack = stk;
        symTable = symtbl;
        output = ot;
        ...
        semaphore = sem;
        this.lock = (lock != null) ? lock : new MyLock();
    }
